...
export const STYLE_TAG_PROMPT = `- style_tags: Subset of exactly ${JSON.stringify(
  ...
  - "cottage": the romantic English cottage-garden tradition — informal, billowing, nostalgic abundance. Hollyhocks, foxgloves, delphiniums, lupins, sweet peas, old roses, aquilegias. The test: would a book on cottage gardens name this plant? Not a default for every charming flowering plant.
