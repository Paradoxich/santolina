  ...
  return (
    <button
      ...
      className={[
        ...
        selected
          ? 'rounded-[var(--radius-lg)] border border-white bg-[var(--color-background-card)]'
          : 'border-b border-white hover:rounded-[var(--radius-lg)] hover:border-transparent hover:bg-[var(--color-background-hover)]',
      ].join(' ')}
    >
