 ...
 *
 * So this is the runbook as code. The ordered list below IS docs/curation.md#round-runbook, and having it
  ...
  if (!label) {
    console.error(
      '\nrun-round needs --round <label>.\n\n' +
        'It runs the whole docs/curation.md#round-runbook pipeline for one round. Seed the round first — ' +
